...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?><?php echo PC_VERSION?>  Release <?php echo PC_RELEASE?> <!--[<a href="http://download.phpcms.cn/v9/" target="_blank"><?php echo L('main_latest_version')?></a>]--><br />
...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?>CMS<?php echo PC_VERSION?>  Release <?php echo PC_RELEASE?> [<a href="http://buy.phpcms.cn" target="_blank"><?php echo L('main_support')?></a>]<br />
