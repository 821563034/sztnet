...
<a class="add fb" href="?m=content&c=content&a=add&menuid=&catid=<?php echo $catid;?>&pc_hash=<?php echo $_SESSION['pc_hash'];?>" target="_blank"><em><?php echo L('add_content');?></em></a><!--汪洋-->
...
<tbody>
	...
	?>
		...
		<td align='center'><a href="?m=content&c=content&a=edit&catid=<?php echo $catid;?>&id=<?php echo $r['id']?>&pc_hash=<?php echo $_SESSION['pc_hash'];?>" target="_blank"><?php echo L('edit');?></a> | <a href="javascript:view_comment('<?php echo id_encode('content_'.$catid,$r['id'],$this->siteid);?>','<?php echo safe_replace($r['title']);?>')"><?php echo L('comment');?></a></td><!--汪洋---->
	</tr>
     <?php }
	}
	?>
